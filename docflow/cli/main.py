...
@click.option("--yes", is_flag=True, help="Skip the item picker and document suggested units.")
@click.option("--include", "include_sections", multiple=True, help="Item name to include (repeatable).")
@click.option("--exclude", "exclude_sections", multiple=True, help="Item name to skip (repeatable).")
@click.option("--extra", "extra_sections", multiple=True, help="Extra file path to document.")
